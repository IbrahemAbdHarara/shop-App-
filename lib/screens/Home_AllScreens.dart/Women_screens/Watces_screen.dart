...
import 'package:shop_test/widget/widget_women/widget_watces.dart';

class Watces_Screen extends StatelessWidget {
  @override
         ...
         children: [
           Expanded(
             ...
             itemCount: DataShop.length,
              itemBuilder: (_,index){
           return  Widget_watces(DataShop[index].model_women!);

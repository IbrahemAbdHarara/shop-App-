...
class Order_Women2 extends StatelessWidget {
  Model_Women model_women;

  Order_Women2(this.model_women);
                      ...
                      Stack(
                        children: [
                          Container(
                            ...
                            child: Text(
                              model_women.jewelry_price.toString(),
                              style: const TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.black,
 ...
 Model_db model_db=Model_db(comment: model_women.jewelry_comment, price: model_women.jewelry_price, image: model_women.jewelry_image);
